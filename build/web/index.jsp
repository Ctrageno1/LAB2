                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                       ...
                       <c:if test="${sessionScope.acc.admin == 1}"> <li class="nav-item"><a class="nav-link" href="#!">Admin</a></li></c:if>
                        <c:if test="${sessionScope.acc.seller == 1}"><li class="nav-item"><a class="nav-link" href="manage">Seller</a></li></c:if>
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Phone Sale</h1>
                    <p class="lead fw-normal text-white-50 mb-0">Iphone Sony Xiaomy Vivo Oppo</p>
                </div>
            </div>
        </header>
        <!-- Section-->
                    ...
                    <div class="col-md-3">
                        ...
                        <ul class="list-group">
                            <c:forEach items="${list}" var="c">
                                <li class="list-group-item"><a href="filterCategory?categoryId=${c.id}">${c.name}</a></li>
                                </c:forEach>
                        </ul></div>
                    <div class="col-md-9"> <h3>List Product</h3><div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3  justify-content-center">
                                ...
                                <div class="col mb-5">
                                    ...
                                    <div class="card h-100">
                                        ...
                                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="detailSeve?pid=${p.id}">Add to cart</a></div>
                                        </div>
                                    </div>
                                </div>
                            </c:forEach>
